//! Acme OpenRPC render regression against golden fixtures.
//!
//! Refresh baselines: `UPDATE=1 cargo test -p switchback-mdbook openrpc_regression -- --nocapture`

mod common;

use common::{collect_tree, load_openrpc_acme, render_manual};
use std::collections::BTreeMap;
use std::fs;
use std::path::{Path, PathBuf};
use switchback_traits::Layout;

const GOLDEN_ROOT: &str = "tests/fixtures/golden/openrpc_acme";
...
#[test]
fn openrpc_acme_render_matches_golden() {
