...
pub struct OpenRpcContract {
    family: OpenRpcFamily,
...
impl Contract for OpenRpcContract {
...
impl OpenRpcContract {
    pub fn entity_refs_for_group(
        &self,
        group: &Group,
    ) -> Vec<(&Entity<OpenRpcCategory>, &[Reference])> {
